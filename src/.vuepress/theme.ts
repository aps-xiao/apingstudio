...
export default hopeTheme({
  hostname: "https://github.com/aps-xiao/apingstudio",

  author: {
    name: "aps-xiao",
    url: "https://github.com/aps-xiao",
  },
  ...
  blog: {
    medias: {
      ...
      BiliBili: "https://space.bilibili.com/331466888",
      ...
      Gitee: "https://gitee.com/aps-xiao",
      GitHub: "https://github.com/aps-xiao",
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "An idealist who likes to fool around.",
        intro: "/intro.html",
      },
  ...
  plugins: {
    ...
    comment: {
       ...
       */
      provider: "Giscus",
      repo: "aps-xiao/giscus-discussions",
      repoId: "R_kgDOI5ZMzQ",
      category: "General",
      categoryId: "DIC_kwDOI5ZMzc4CT-ry",
