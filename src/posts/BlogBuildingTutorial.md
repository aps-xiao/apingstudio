...
## 二、Create a VuePress Theme Hope Project
...
## 2、Create github warehouse

### 2.1 The warehouse name is the same as the user name
...
### 2.2 The warehouse name is different from the user name
